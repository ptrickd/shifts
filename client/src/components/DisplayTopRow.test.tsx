...
test("render DisplayTopRow properly when the week is separate in 2 months", () => {
  render(
    <DisplayTopRow
      weekDays={TOP_ROW}
      today={new Date(Date.now())}
      weekStart={new Date("2023-12-31")}
    />
  );
...
test("render DisplayTopRow properly when the week is separate in 2 months: 31 days month", () => {
  render(
    <DisplayTopRow
      weekDays={TOP_ROW}
      today={new Date(Date.now())}
